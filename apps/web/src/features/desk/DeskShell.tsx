...
function Sidebar({
  ...
  const overviewLink: SideLink = { href: "/desk", label: isAdmin ? "Home" : "Overview", icon: LayoutDashboard, count: tickets.length || undefined, active: onBoard };
  const views: SideLink[] = [
    { href: "/desk/queue?tab=mine", label: "My Tickets", icon: UserRound, count: mine || undefined, active: unfilteredQueue && tab === "mine" },
  ];
  ...
  const queueLinks: SideLink[] = [
    { href: "/desk/queue?tab=unassigned&sort=oldest", label: "Incoming", icon: Inbox, count: unassigned || undefined, active: onQueue && tab === "unassigned" },
    { href: "/desk/queue?tab=all", label: "All requests", icon: Layers, count: openQueue || undefined, active: unfilteredQueue && tab === "all" },
  ];
  ...
  const categories: SideLink[] = byCategory
    ...
    .map((c) => ({
      href: `/desk/queue?tab=all&categoryId=${c.categoryId}`,
  ...
  const adminLinks: SideLink[] = [
    { href: "/desk/admin", label: "Dashboard", icon: LayoutDashboard, active: pathname === "/desk/admin" || pathname === "/desk/admin/" },
    { href: "/desk/admin/admins", label: "Admin", icon: ShieldCheck, active: pathname.startsWith("/desk/admin/admins") },
    { href: "/desk/admin/agents", label: "Agents", icon: Users, active: pathname.startsWith("/desk/admin/agents") },
    { href: "/desk/admin/audit", label: "Audit", icon: History, active: pathname.startsWith("/desk/admin/audit") },
    { href: "/desk/admin/known-issues", label: "Known issues", icon: TriangleAlert, active: pathname.startsWith("/desk/admin/known-issues") },
    { href: "/desk/admin/settings", label: "Settings", icon: Settings, active: pathname.startsWith("/desk/admin/settings") },
  ];
      ...
      >
        ...
        {collapsed ? (
          <div className="flex flex-col items-center gap-1">
            ...
            {isAdmin && (
              <SideLinkRow
                link={{ href: "/admin", label: "Administration", icon: ShieldCheck, active: onAdminRoute }}
                collapsed
              />
            )}
