...
const CARDS: {
  ...
  { key: "unassigned", label: "Unassigned", to: "/desk/queue?tab=unassigned", hint: "Needs an owner" },
  { key: "pending", label: "Pending", to: "/desk/queue?tab=all&status=pending", hint: "Assigned, not opened" },
  { key: "mine", label: "Mine", to: "/desk/queue?tab=mine", hint: "Your open tickets" },
  { key: "breachingSoon", label: "Breaching soon", to: "/desk/queue?tab=all&sort=due", hint: "SLA pressure" },
  { key: "receivedToday", label: "Received today", to: "/desk/queue?tab=all&sort=newest", hint: "Fresh intake" },
  { key: "resolvedByMeToday", label: "Resolved by me today", to: "/desk/queue?tab=mine", hint: "Your wins" },
];
